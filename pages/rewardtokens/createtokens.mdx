...
- `tokenAddress`: the contract address of the NFT
- `name`: the name of the NFT
- `symbol`: the symbol or ticker of the NFT
- `creatorAddress`: the account address that created the NFT
- `transactionHash`: the hash of the transaction that created the NFT on the blockchain.
